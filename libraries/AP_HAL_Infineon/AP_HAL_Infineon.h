...
/**
 * Umbrella header for AP_HAL_Infineon module.
 ...
 * names, headers) via the Infineon namespace.
 * The class implementing AP_HAL::HAL should be called HAL_Infineon and exist
 * in the global namespace. There should be a single const instance of the
 * HAL_Infineon class called AP_HAL_Infineon, instantiated in the HAL_Infineon_Class.cpp
 * and exported as `extern const HAL_Infineon AP_HAL_Infineon;` in HAL_Infineon_Class.h
 *
 * All declaration and compilation should be guarded by CONFIG_HAL_BOARD macros.
 * In this case, we're using CONFIG_HAL_BOARD == HAL_BOARD_Infineon.
